...
int main(void)
{
  ...
  MX_TIM6_Init();
  /* USER CODE BEGIN 2 */
  app_init(&hadc1, &hspi2, &hspi3, &htim2, &htim3, &htim5, &htim6, &hiwdg);
  /* USER CODE END 2 */
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOB, STAT3_Pin|BAR_CS_Pin|STAT1_Pin|STAT2_Pin
  ...
  /*Configure GPIO pins : STAT3_Pin BAR_CS_Pin STAT1_Pin STAT2_Pin
                           RF_CS_Pin RF_CE_Pin */
  GPIO_InitStruct.Pin = STAT3_Pin|BAR_CS_Pin|STAT1_Pin|STAT2_Pin
                          |RF_CS_Pin|RF_CE_Pin;
  ...
  /*Configure GPIO pin : BAR_IRQ_Pin */
  GPIO_InitStruct.Pin = BAR_IRQ_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(BAR_IRQ_GPIO_Port, &GPIO_InitStruct);
